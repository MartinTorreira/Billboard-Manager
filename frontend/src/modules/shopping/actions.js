...
export const buy = (sessionId, quantity, creditCard, onSuccess,
                    onErrors) => dispatch =>
    backend.shoppingService.buy(sessionId, quantity, creditCard, id => {
...
export const deliverTicket = (creditCard, orderId, onSuccess, onErrors) => dispatch =>
    backend.shoppingService.deliverTickets(creditCard, orderId,
        () => {onSuccess();},
        onErrors);
